...
def open_history(bot, message, user_list, from_user):
    print(user_list[from_user].history)
    ...
    if len(history) > 0:
        ...
        for num, i_history in enumerate(history, 1):
            ...
            keyboard.add(types.InlineKeyboardButton(text=i_message, callback_data='history_' + history[i_history][0] +'_' + i_history))
